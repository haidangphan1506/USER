      ...
      throw new HttpException(
        {
          ...
          // Preserve the origin service's name if the error already carried one through (e.g.
          // relaying tutor-service's error back to gateway) — don't overwrite it with our own.
